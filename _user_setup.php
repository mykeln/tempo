<div class="container">
  <div class="col-sm-4">
    ...
    <form class="form-horizontal" name="signup" action="?p=sign_up" method="post">
      <div class="control-group">
        <label class="control-label" for="inputName">Full Name</label>
        <div class="controls">
          <input class="form-control" type="text" id="inputName" placeholder="Mykel Nahorniak">
        </div>
      </div>
      <div class="control-group">
        <label class="control-label" for="inputEmail">Email</label>
        <div class="controls">
          <input class="form-control" type="text" id="inputEmail" placeholder="myname@chainiac.com">
        </div>
      </div>
      <div class="control-group">
        <label class="control-label" for="inputWeight">Weight (lbs)</label>
        <div class="controls">
          <input class="form-control" type="text" id="inputWeight" placeholder="145">
        </div>
      </div>
      <div class="control-group">
      ...
      <div class="control-group" id="s5">
        ...
        <div class="controls">
          <input class="form-control" type="text" id="input5s" placeholder="1390">
        </div>
      </div>
      <div class="control-group" id="m1">
        <label class="control-label" for="input1m">1-Minute Power</label>
        <div class="controls">
          <input class="form-control" type="text" id="input1m" placeholder="550">
        </div>
      </div>
      <div class="control-group" id="m5">
        <label class="control-label" for="input5m">5-Minute Power</label>
        <div class="controls">
          <input class="form-control" type="text" id="input5m" placeholder="380">
        </div>
      </div>
      <div class="control-group" id="m20">
        <label class="control-label" for="input20m">20-Minute Power</label>
        <div class="controls">
          <input class="form-control" type="text" id="input20m" placeholder="290">
        </div>
      </div>


      <button type="submit" class="btn btn-primary pull-right">Build My Plan</button>
  ...
  <div class="col-sm-4 col-sm-offset-2">
    ...
    <form class="form-horizontal" name="signin" action="?p=sign_in" method="post">
      <div class="control-group">
        ...
        <div class="controls">
          <input class="form-control" type="text" id="inviteCode" name="inviteCode" placeholder="myke">
        </div>
      </div>
