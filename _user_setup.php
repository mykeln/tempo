  ...
  <div class="col-sm-4">
    ...
    <form class="form-horizontal" name="signup" action="?p=sign_up" method="post">
      <div class="control-group">
        ...
        <div class="controls">
          <input class="form-control" type="text" name="inputName" id="inputName" placeholder="Mykel Nahorniak">
        </div>
      </div>
      <div class="control-group">
        <label class="control-label" for="inputEmail">Email</label>
        <div class="controls">
          <input class="form-control" type="text" name="inputEmail" id="inputEmail" placeholder="myname@chainiac.com">
        </div>
      </div>
      <div class="control-group">
        <label class="control-label" for="inputPassword">Password</label>
        <div class="controls">
          <input class="form-control" type="text" name="inputPassword" id="inputPassword" placeholder="">
        </div>
      </div>
      <div class="control-group">
